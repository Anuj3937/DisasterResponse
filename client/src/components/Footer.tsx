...
const Footer = () => {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    toast({
      title: "Success",
      description: "You have successfully subscribed to emergency alerts.",
    });
    setEmail("");
  };
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Providing critical disaster management and emergency response coordination nationwide.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400">Subscribe to emergency alerts:</p>
            <form onSubmit={handleSubscribe} className="mt-2 flex">
              <Input 
                type="email" 
                placeholder="Your email" 
                className="bg-gray-800 border-gray-700 rounded-l-lg focus:outline-none"
                value={email}
                onChange={(e) => setEmail(e.target.value)} 
              />
              <Button type="submit" className="bg-primary hover:bg-red-700 rounded-r-lg text-white font-medium">
                Subscribe
              </Button>
            </form>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500">&copy; {new Date().getFullYear()} DisasterResponse. All rights reserved.</p>
